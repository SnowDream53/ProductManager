...
"color: #444;")
        ...
        self.btn_login.setGeometry(QRect(10, 310, 361, 41))
...
"}")
        ...
        self.btn_signup.setGeometry(QRect(130, 520, 118, 21))
...
"color: #000;\n"
"}")
        self.lbl_have_not_account_yet = QLabel(self.centralwidget)
        self.lbl_have_not_account_yet.setObjectName(u"lbl_have_not_account_yet")
        self.lbl_have_not_account_yet.setGeometry(QRect(130, 500, 121, 21))
        self.lbl_have_not_account_yet.setStyleSheet(u"color: #444;\n"
"font-size: 12px;")
...
"")
        ...
        self.layoutWidget.setGeometry(QRect(0, 40, 381, 69))
        ...
        self.lbl_login = QLabel(self.layoutWidget)
        self.lbl_login.setObjectName(u"lbl_login")
        self.lbl_login.setStyleSheet(u"color: #1A1B1F;\n"
...
"line-height: 1.3;")
        ...
        QWidget.setTabOrder(self.le_password, self.btn_login)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_have_not_account_yet.setText(QCoreApplication.translate("MainWindow", u"Have not account yet?", None))
